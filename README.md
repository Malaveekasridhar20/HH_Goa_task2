...
The results demonstrate that dense and sparse retrieval provide complementary behavior across languages.

The 70/30 fusion configuration was retained based on the evaluation rather than assuming that either retrieval method alone was universally optimal.
